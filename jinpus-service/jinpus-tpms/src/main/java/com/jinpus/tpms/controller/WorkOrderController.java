...
public class WorkOrderController {
    ...
    public R getDetails(@ParameterObject WorkOrderDo workOrder) {
        return R.ok(workOrderService.list(Wrappers.query(workOrder)));
    }
    ...
    public R save(@RequestBody WorkOrderDo workOrder) {
    ...
    public R updateById(@RequestBody WorkOrderDo workOrder) {
