...
import com.jps.admin.api.entity.*;
import com.jps.admin.api.util.ParamResolver;
import com.jps.admin.api.vo.ContextUserVo;
import com.jps.admin.api.vo.UserExcelVO;
import com.jps.admin.api.vo.UserVO;
import com.jps.admin.mapper.SysUserMapper;
import com.jps.admin.mapper.SysUserPostMapper;
import com.jps.admin.mapper.SysUserRoleMapper;
import com.jps.admin.service.*;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
	 ...
	 */
	@Override
	public ContextUserVo findUserInfo(SysUser sysUser) {
		// KP findUserInfo :Security上下文新增部门名称
		Long deptId = sysUser.getDeptId();
		SysDept byId = sysDeptService.getById(deptId);
//		UserInfo userInfo = new UserInfo();
		ContextUserVo userInfo = new ContextUserVo();
		BeanUtils.copyProperties(sysUser,userInfo);
		userInfo.setDeptName(byId.getName());
